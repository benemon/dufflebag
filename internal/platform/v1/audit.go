...
var operationDescriptors = map[string]operationDescriptor{
	...
	"GetVersionFindingsSummary": {method: http.MethodGet, path: "/api/v1/organizations/{organizationId}/projects/{projectId}/buckets/{bucketName}/versions/{fingerprint}/findings-summary", Descriptor: audit.Descriptor{Operation: "findings_summary.read", TargetType: "version", TargetIDParam: "fingerprint"}},
