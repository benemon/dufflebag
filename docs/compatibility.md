...
[spec/vendor/PROVENANCE.md](../spec/vendor/PROVENANCE.md).
...
([`e2e/packer/e2e.test.mjs`](../e2e/packer/e2e.test.mjs),
[`e2e/packer/local-child.pkr.hcl`](../e2e/packer/local-child.pkr.hcl)) —
...
recorded once, in [CONTRIBUTING.md](../CONTRIBUTING.md). The rule this
